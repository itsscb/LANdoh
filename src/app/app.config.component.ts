            ...
            <div class="layout-config-content">
                ...
                <p-tabView id="config-form-tabs">
                    <p-tabPanel header="Light or Dark">
                        <h1>Light or Dark</h1>
                        <p>landoh offers all dark dashboard &amp; theme design for dark lovers.</p>
                        <div class="grid justify-content-center align-items-center">
                            <div class="col col-fixed">
                                <a href="#" class="layout-config-option layout-config-option-image" (click)="changeLayout($event, false)">
                                    <img src="assets/layout/images/configurator/choice-light.png" alt="landoh-layout" style="width:100%"/>
                            ...
                            <div class="col col-fixed md:col-offset-1">
                                <a href="#" class="layout-config-option layout-config-option-image" (click)="changeLayout($event, true)">
                                    <img src="assets/layout/images/configurator/choice-dark.png" alt="landoh-layout" style="width:100%"/>
                            ...
                            <div class="col col-fixed">
                                <a href="#" class="layout-config-option layout-config-option-image"
                                   (click)="changeMenuToHorizontal($event,true)">
                                    <img src="assets/layout/images/configurator/menu/horizontal.png" alt="landoh-layout" style="width:100%"/>
                            ...
                            <div class="col col-fixed">
                                <a href="#" class="layout-config-option layout-config-option-image"
                                   (click)="changeMenuToHorizontal($event,false)">
                                    <img src="assets/layout/images/configurator/menu/overlay.png" alt="landoh-layout" style="width:100%"/>
