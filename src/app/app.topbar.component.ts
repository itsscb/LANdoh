				...
				<div class="layout-topbar-left">
					...
					<div style="display: flex; flex-grow: 1;">
						<a href="#" style="display: flex; align-items:center;">
							...
							<span style="font-size: 22.5px; color: #d8dee9; margin-left: 10px;">LAN Distributor of Hell</span>
						</a>
					</div>
					...
					<ul class="layout-topbar-actions">
						...
						<li #message class="topbar-item" [ngClass]="{'active-topmenuitem': appMain.activeTopbarItem === message}">
							...
							<ul class="fadeInDown">
								...
								<li class="layout-submenu-item">
									<img src="assets/layout/images/topbar/avatar-cayla.png" alt="landoh-layout" width="35" />
									<div class="menu-text">
								...
								<li class="layout-submenu-item">
									<img src="assets/layout/images/topbar/avatar-gabie.png" alt="landoh-layout" width="35" />
									<div class="menu-text">
								...
								<li class="layout-submenu-item">
									<img src="assets/layout/images/topbar/avatar-gaspar.png" alt="landoh-layout" width="35" />
									<div class="menu-text">
								...
								<li class="layout-submenu-item">
									<img src="assets/layout/images/topbar/avatar-tatiana.png" alt="landoh-layout" width="35" />
									<div class="menu-text">
						...
						<li #gift class="topbar-item" [ngClass]="{'active-topmenuitem': appMain.activeTopbarItem === gift}">
							...
							<ul class="fadeInDown">
								...
								<li class="deals">
									<ul>
										<li>
											<img src="assets/layout/images/topbar/deal-icon-sapphire.png" alt="landoh-layout" width="35" />
											<div class="menu-text">
												<p>Sapphire</p>
												<span>Angular</span>
											</div>
										...
										<li>
											<img src="assets/layout/images/topbar/deal-icon-roma.png" alt="landoh-layout" width="35" />
											<div class="menu-text">
												<p>Roma</p>
										...
										<li>
											<img src="assets/layout/images/topbar/deal-icon-babylon.png" alt="landoh-layout" width="35" />
											<div class="menu-text">
												<p>Babylon</p>
												<span>Powerful</span>
											</div>
									...
									<ul>
										<li>
											<img src="assets/layout/images/topbar/deal-icon-harmony.png" alt="landoh-layout" width="35" />
											<div class="menu-text">
												<p>Harmony</p>
												<span>USWDS</span>
											</div>
										...
										<li>
											<img src="assets/layout/images/topbar/deal-icon-prestige.png" alt="landoh-layout" width="35" />
											<div class="menu-text">
												<p>Prestige</p>
												<span>Elegancy</span>
											</div>
										...
										<li>
											<img src="assets/layout/images/topbar/deal-icon-ultima.png" alt="landoh-layout" width="35" />
											<div class="menu-text">
												<p>Ultima</p>
												<span>Material</span>
											</div>
						...
						<li #profile class="topbar-item profile-item" [ngClass]="{'active-topmenuitem': appMain.activeTopbarItem === profile}">
                            ...
                            <span class="profile-image-wrapper">
                                <img src="assets/layout/images/topbar/avatar-eklund.png" alt="landoh-layout" />
                            </span>
							...
							<ul class="profile-item-submenu fadeInDown">
								<li class="profile-submenu-header">
									<div class="performance">
										...
										<img src="assets/layout/images/topbar/asset-bars.svg" alt="landoh-layout" />
									</div>
									<div class="profile">
										<img src="assets/layout/images/topbar/avatar-eklund.png" alt="landoh-layout"
														width="40" />
								...
								<li class="layout-submenu-footer">
									...
									<button class="buy-landoh-button">Buy landoh</button>
								</li>
							</ul>
						</li>
						<li>
						...
						<li #mobileProfile class="topbar-item profile-item" [ngClass]="{'active-topmenuitem': appMain.activeTopbarItem === mobileProfile}">
							...
							<ul class="fadeInDown">
								<li class="profile-submenu-header">
									...
									<div class="profile">
										<img src="assets/layout/images/topbar/avatar-eklund.png" alt="landoh-layout" width="45" />
										<h1>Olivia Eklund</h1>
										<span>Design</span>
									</div>
								</li>
