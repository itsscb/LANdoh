					...
					<div class="weather">
						...
						<ul class="weather-list">
							<li class="weather-list-item">
								...
								<div class="weather-info">
									<div class="weather-icon icon-1">
										<img src="assets/layout/images/rightpanel/weather-icon-1.svg" alt="landoh-layout" />
									</div>
							...
							<li class="weather-list-item">
								...
								<div class="weather-info">
									<div class="weather-icon icon-2">
										<img src="assets/layout/images/rightpanel/weather-icon-3.svg" alt="landoh-layout" />
									</div>
									<div class="weather-value">
										26°
									</div>
							...
							<li class="weather-list-item">
								...
								<div class="weather-info">
									<div class="weather-icon icon-1">
										<img src="assets/layout/images/rightpanel/weathericon-4.svg" alt="landoh-layout" />
									</div>
									<div class="weather-value">
										23°
									</div>
							...
							<li class="weather-list-item">
								...
								<div class="weather-info">
									<div class="weather-icon icon-3">
										<img src="assets/layout/images/rightpanel/weather-icon-4.svg" alt="landoh-layout" />
									</div>
									<div class="weather-value">
										31°
									</div>
